        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="number" class="form-control form-control" id="stu_farSchool" name="stu_farSchool"
                    placeholder="ใส่เป็นกิโลเมตร" required11>
            </div>
        </div>
        <div class="form-group row">
