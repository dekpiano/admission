                        ...
                        <div id="collapseThree" class="collapse show" aria-labelledby="headingThree"
                            ...
                            <div class="card-body">
                                ...
                                foreach($sel_date as $v_datatN) :
                                    ...
                                    if($v_datatN->recruit_date > "2023-01-01" && $v_datatN->recruit_date < "2023-01-30"): 
                                ?>
                                                            <tr>
                                       ...
                                       $sub11N = 0; $sub12N = 0; $sub13N = 0; $sub14N = 0; $sub15N = 0;
                                        foreach($sum_date as $m1N) {
                                            ...
                                            if($m1N->recruit_date > "2023-01-01" && $m1N->recruit_date < "2023-01-30"){
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                ...
                                foreach($sel_date as $v_datat) :
                                    //echo "<pre>";print_r($v_datat);
                                    if($v_datat->recruit_date > "2023-01-01" && $v_datat->recruit_date < "2023-01-30"): 
                                ?>
                                                            <tr>
                                                                <td style="width:150px">
