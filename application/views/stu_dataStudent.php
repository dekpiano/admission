                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="recruit_homeSubdistrict"
                                                name="recruit_homeSubdistrict"
                                                value="<?=$stu->recruit_homeSubdistrict;?>" required>
                                            <div class="invalid-feedback">
                                                ระบุตำบล/แขวง
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="recruit_homedistrict"
                                                name="recruit_homedistrict" value="<?=$stu->recruit_homedistrict?>"
                                                required>
                                            <div class="invalid-feedback">
                                                ระบุอำเภอ/เขต
                                            </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="recruit_homeProvince"
                                                name="recruit_homeProvince" value="<?=$stu->recruit_homeProvince?>"
                                                required>
                                            <div class="invalid-feedback">
                                                ระบุจังหวัด
                                            </div>
