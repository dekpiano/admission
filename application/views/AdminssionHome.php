    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            ...
            <tbody class="text-center bg-white">
                ...
                <tr>
                    <th scope="row">รอบปกติ (เพิ่มเติม)</th>
                    <td>
                        21 - 23 เมษายน 2568 <br>
                        เปิดระบบ 08.30 น. และปิดระบบ เวลา 16.30 น.

                    </td>
                    <td>29 เมษายน 2568 <br> (07.30 - 12.00 น.)</td>
                    <td>1 พฤษภาคม 2568</td>
                    <td>7 พฤษภาคม 2568 (07.30 - 12.00 น.)</td>
                </tr>
