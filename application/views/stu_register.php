        ...
        <div class="container-fluid mt-5">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">ข้อมูลการสมัคร ชั้นมัธยมศึกษาปีที่ <?=$this->uri->segment(2)?></h1>
                                    ...
                                    <div class="row ">
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <select class="form-control" id="recruit_prefix" name="recruit_prefix"
                                                required data-toggle="tooltip" data-placement="top" title="คำนำหน้า">
                      ...
                      for ($i=($year-30);$i<=($year);$i++) : ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="tel" class="form-control" id="recruit_phone"
                                    ...
                                    <div class="d-block my-3">
                                        ...
                                        <div class="custom-control custom-radio">
                                            <input id="debit" name="recruit_tpyeRoom" type="radio"
                                                class="custom-control-input"
                                                value="ห้องเรียนความเป็นเลิศทางด้านภาษา (Chinese English Program)"
                                                required>
                                            <label class="custom-control-label"
                                                for="debit">ห้องเรียนความเป็นเลิศทางด้านภาษา
                                                (Chinese
                                    ...
                                    <div class="form-check text-center">
                                        <input class="form-check-input " type="checkbox" id="check_proviso"
