...
<header class="pt-5">
    <div class="container-fluid text-center">
        <img src="https://skj.ac.th/uploads/logo/LogoSKJ_4.png" alt="logoSKJ" class="img-fluid" style="width: 100px;">
        <h2 class="text-white mt-3">ระบบรับสมัครนักเรียน ส.ก.จ.</h2>
    </div>
</header>
...
<div id="SectionFormRegisterStudents" style="display:none;">
        ...
        <div class="">
            <div class="row ">
                <div class="col-md-12 order-md-1 ">
                    <form class="needs-validation contact-block" enctype="multipart/form-data" method="post"
                        novalidate="" action="<?=base_url('control_admission/reg_insert')?>">
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <label for="recruit_img">อัพโหลดรูปถ่าย (รูปถ่ายหน้าตรงชุดนักเรียน) <a
                                    ...
                                    <div class="row ">
                                        <div class="col-md-8 mb-3 col-lg-2 ">
                                            <div class="dek-floating-label">
                                                <input type="text" class="dek-floating-input" id="recruit_year"
                                                    value="<?=$checkYear[0]->openyear_year;?>" readonly placeholder=" ">
                                                <label for="recruit_year">ประจำปีการศึกษา <span
                                        ...
                                        <div class="col-md-4 mb-3 col-lg-4">
                                            <div class="dek-floating-label">
                                                ...
                                                <input type="text" class="form-control" id="recruit_category"
                                                    name="recruit_category" hidden
                                                    value="<?=$TypeQuota[0]->quota_key;?>" readonly>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="dek-floating-label">
                                                <input type="text" class="dek-floating-input" id="recruit_firstName"
                                                    name="recruit_firstName" placeholder=" " required
                                                    data-toggle="tooltip" data-placement="top"
                                                    title="ชื่อของนักเรียน" />
                                                <label for="recruit_firstName">ชื่อ <span class="text-red">*</span>
                                                </label>
                                                <div class="invalid-feedback">
                                                    ระบุชื่อของนักเรียน
                                                </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="dek-floating-label">
                                                ...
                                                <input type="text" class="dek-floating-input" id="recruit_lastName"
                                                    name="recruit_lastName" placeholder=" " required
                                                    data-toggle="tooltip" data-placement="top"
                      ...
                      for ($i=($year-30);$i<=($year);$i++) : ?>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="dek-floating-label">
                                                ...
                                                <label for="recruit_race">เชื้อชาติ <span class="text-red">*</span>
                                                </label>
                                                <div class="invalid-feedback">
                                                    ระบุเชื้อชาติ
                                                </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="dek-floating-label">
                                                ...
                                                <label for="recruit_religion">ศาสนา <span class="text-red">*</span>
                                                </label>
                                                <div class="invalid-feedback">
                                                    ระบุศาสนา
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            <div class="dek-floating-label">
                                                ...
                                                <label for=" recruit_homeNumber">บ้านเลขที่ <span
                                                        class="text-red">*</span>
                                                </label>
                                                <div class="invalid-feedback">
                                                    ระบุเลขที่บ้าน
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <div class="dek1-floating-label">
                                                <input type="text" class="dek1-floating-input"
                                                    id="recruit_homeSubdistrict" name="recruit_homeSubdistrict"
                                                    placeholder=" ">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="dek1-floating-label">
                                                ...
                                                <label for="recruit_homedistrict">อำเภอ/เขต <span
                                                        class="text-red">*</span>
                                                </label>
                                                <div class="invalid-feedback">
                                                    ระบุอำเภอ/เขต
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="dek1-floating-label">
                                                ...
                                                <label for="recruit_homeProvince">จังหวัด <span
                                                        class="text-red">*</span>
                                                </label>
                                                <div class="invalid-feedback">
                                                    ระบุจังหวัด
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="dek-floating-label">
                                                <input type="text" class="dek-floating-input" id="recruit_district"
                                                    name="recruit_district" placeholder=" " required
                                                    data-toggle="tooltip" data-placement="top"
                                                    title="อำเภอของโรงเรียนที่จบการศึกษา">
                                                <label for="recruit_district">อำเภอ <span class="text-red">*</span>
                                                </label>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="dek-floating-label">
                                                <input type="text" class="dek-floating-input" id="recruit_province"
                                                    name="recruit_province" placeholder=" " required
                                                    data-toggle="tooltip" data-placement="top"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input id="paypal" name="recruit_tpyeRoom" type="radio"
                                            ...
                                            required>
                                        <label class="custom-control-label"
                                            for="paypal">ห้องเรียนความเป็นเลิศทางด้านดนตรี
                                            ศิลปะ
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <label for="recruit_certificateEdu">ใบรับรองผลการเรียน (ปพ.1)
                                                <u>ด้านหน้า</u> <a href="#" data-toggle="tooltip" data-placement="top"
                                                    data-html="true"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="file" class="form-control"
                                                id="recruit_certificateAbility<?=$i;?>"
